      ...
      <form class="form-horizontal" action="<?php echo(htmlspecialchars($_SERVER['PHP_SELF'])); ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
        <fieldset>
          <div class="control-group">
            ...
            <div class="control-group">
              <label class="control-label" for="typeahead">Registration Id</label>
              <div class="controls">
                <input type="tags" class="span6 typeahead" id="tags" name="reg_id">
              </div>
            </div>
              ...
              $reg=mysqli_real_escape_string($con,$reg);
            	...
            	if(preg_match("!image!",$_FILES['image']['type'])){
            		if(copy($_FILES['image']['tmp_name'],$image)){
            			...
            			$sql="INSERT INTO event(event_title,received,image,description,reg_id)
            			VALUES('$title','$received','$image','$description','$reg')";
